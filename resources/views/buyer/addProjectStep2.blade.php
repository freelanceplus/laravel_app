                                ...
                                <div class="card border-0">
                                    <div class="card-body p-4">
                                        <div class="card-title">
                                            <h3 class="text-center title-2 mt-1 font-weight-bold">Step 2</h3>
                                        </div>
                                        <hr>
                                        <form action="{{ url('/buyer/addProject/step2') }}" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="deadline" name="deadline" type="date"
                                                       class="form-control cc-name valid {{ $errors->has('deadline') ? ' is-invalid' : '' }}" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" rows="4" placeholder="" class="form-control"></textarea>
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
