                                ...
                                <div class="card border-0">
                                    <div class="card-body p-4">
                                        <div class="card-title">
                                            <h3 class="text-center title-2 mt-1 font-weight-bold">Edit Question</h3>
                                        </div>
                                        <hr>
                                        <form action="{{ route('editQuestion', $questions[0]->id) }}" method="POST" enctype="multipart/form-data"
