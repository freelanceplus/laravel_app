                ...
                .on("value", snap => {
                    ...
                    Object.keys(chats).forEach(function (key){
                        ...
                        if(chats[key].seller_id != 1) {
                            ...
                            } else if (chats[key].sender == "buyer") {
                                document.getElementById("chat_table").innerHTML += "<tr class=''>" + "<td></td>" + "<td class='text-right'><span class='text-danger'>" + chats[key].buyer_name + ": " + "</span>" + chats[key].message + "</td></tr>";
                            }
                        }
                    });
                    ...
                    <div class="table-responsive table--no-card m-b-10" style="height: 300px; overflow: scroll !important;">
                        <table class="table table-borderless table-striped table-earning">
                            ...
                            <tr>
                                ...
                                <th class="admin-panel-color text-left">Chat</th>
                            </tr>
                            </thead>
                            <tbody id="chat_table">
