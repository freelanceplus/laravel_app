                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 shadow">
                                <div class="card border-0 pt-4 pl-4 pr-4 pb-1">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Revise <strong>{{ $order_details->title }}</strong> from
                                                <strong>{{ $seller_name }}</strong>
                                            </h3>
                                        </div>
                                        <hr>
                                        <form action="{{ route('adminReviseProject', $order_id) }}" method="POST" novalidate="novalidate">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <button type="submit" class="btn btn-lg"
                                                        style="width: 50%; border-radius: 12px; background-color: #000000; color:white">REVISE
                                                </button>
                                            </div>
